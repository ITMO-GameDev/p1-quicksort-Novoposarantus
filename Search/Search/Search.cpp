// Search.cpp : Defines the functions for the static library.
//
...
//}
//
////проверить работоспособность swap
//template<typename K, typename V>
...
//
//template<typename K, typename V>
//int Dictionary<K, V>::getHeight(Node<K, V>* node) {
//    if (node == nullptr) {
//        return 0;
//    }
//
...
//
//template<typename K, typename V>
//Node<K, V> Dictionary<K, V>::find(Node<K, V>*& root, K*& key) {
//    if (root == nullptr) {
//        return nullptr;
//    }
//
...
//
//template<typename K, typename V>
//bool Dictionary<K, V>::Iterator::isLeftToParent(Node<K, V>& node) const {
//    return node.parent->left->key == node.key;
//}
//
//template<typename K, typename V>
//bool Dictionary<K, V>::Iterator::isRightToParent(Node<K, V>& node) const {
//    return node.parent->right->key == node.key;
//}
//
//template<typename K, typename V>
//bool Dictionary<K, V>::Iterator::isParentHasRight(Node<K, V>& node) const {
//    return node.parent->right != nullptr
//}
//
//
//template<typename K, typename V>
//bool Dictionary<K, V>::Iterator::isParentHasleft(Node<K, V>& node) const {
//    return node.parent->left != nullptr
//}
//
//template<typename K, typename V>
//const Node<K, V>& Dictionary<K, V>::Iterator::getNext() const {
...
//
//template<typename K, typename V>
//const Node<K, V>& Dictionary<K, V>::Iterator::findNodeToPrev(Node<K, V>& node) const {
...
//
//template<typename K, typename V>
//const Node<K, V>& Dictionary<K, V>::Iterator::getPrev() const {
//    if (this->current == nullptr) return nullptr;
//    if (this->current.parent == nullptr) return nullptr;
//
...
//template<typename K, typename V>
//Dictionary<K, V>::Iterator::Iterator(Dictionary<K, V>& dictionaryRef) : dictionaryRef(dictionaryRef) {
//    this->current = this->dictionaryRef.root;
//}
//
//template<typename K, typename V>
